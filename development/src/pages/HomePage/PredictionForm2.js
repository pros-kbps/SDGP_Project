...
setTwoTeams = (e) =>{
    for(var i = 0; i<teamList.length; i++){
        ...
        if(teamList[i].id == team1){
            twoTeams.push(teamList[i]);
        }
        if(teamList[i].id == team2){
            twoTeams.push(teamList[i]);
        }
    }
...
const runPred = async (team1,team2,venue,tossWinner,tossDecision) =>{
    console.log(team1,team2,venue,tossWinner,tossDecision);
}
        ...
        <Grid container >
            ...
            <Grid item xs={12} >
                ...
                <Button
                        type="submit"
                        text="Submit"
                        onClick={(e)=> runPred(team1,team2,venue,tossWinner,tossDecision)}
                />
                <Button
                        text="Reset"
                        color="default"
